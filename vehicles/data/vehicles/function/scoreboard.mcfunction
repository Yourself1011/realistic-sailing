scoreboard objectives add windYaw dummy
scoreboard players set global windYaw 9000

scoreboard objectives add windSpeed dummy
scoreboard players set global windSpeed 50

scoreboard objectives add boatYaw dummy
scoreboard players set global boatYaw 0

scoreboard objectives add alignment dummy

scoreboard objectives add sailSpeed dummy
scoreboard objectives add maxSpeed dummy
scoreboard objectives add drag dummy
scoreboard objectives add motionX dummy
scoreboard objectives add motionZ dummy
scoreboard objectives add jitter dummy
...
scoreboard players set global windSpeedTimer 0
...
scoreboard objectives add gustCooldown dummy
scoreboard players set global gustCooldown 0
